...
flowchart TB
    ...
    subgraph itemMod["item"]
        I1[ItemController]
        I2[ItemReviewController]
        I3[CompletionController]
        I4[UploadController]
    ...
    subgraph matchMod["match"]
        M1[MatchController]
        M2[MatchServiceImpl]
        M3[MatchingEngine]
        M4[OwnerMatchService]
    end

    subgraph notifMod["notification"]
        N1[NotificationController]
        N2[NotificationService]
        N3[EmailQueue]
    end

    subgraph statsMod["statistics"]
        ST1[PublicStatsController]
        ST2[AdminStatsController]
    end

    subgraph sysMod["system"]
        SY1[AdminUserController]
        SY2[IdentityReviewController]
        SY3[RootController]
        SY4[DataInitializer]
        SY5[DbFixController]
    end
